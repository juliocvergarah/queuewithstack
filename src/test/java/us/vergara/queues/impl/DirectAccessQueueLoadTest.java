...
public class DirectAccessQueueLoadTest {
	...
	public void test() {
		...
		GenericQueue<Object> queue = new DirectAccessQueue<Object>();
		int itemsConsumed = 0;
		...
		System.out.println("DirectAccessQueueLoadTest total milliseconds: " + (endTime-startTime));
	}
}
