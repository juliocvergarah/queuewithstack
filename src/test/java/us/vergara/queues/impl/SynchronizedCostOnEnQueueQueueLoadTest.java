...
public class SynchronizedCostOnEnQueueQueueLoadTest {
	...
	public void test() {
		...
		GenericQueue<Object> queue = new SynchronizedGenericQueueWrapper<Object>(new CostOnEnQueueQueue<Object>());
		int itemsConsumed = 0;
		...
		System.out.println("SynchronizedCostOnEnQueueQueueLoadTest - Total milliseconds: " + (endTime-startTime));
	}
	...
	public void test_threads() throws InterruptedException {
		...
		Long endTime = System.currentTimeMillis();
		System.out.println("SynchronizedCostOnEnQueueQueueLoadTest total milliseconds (" + NUMBER_OF_THREADS + " threads): " + (endTime-startTime));
	}
