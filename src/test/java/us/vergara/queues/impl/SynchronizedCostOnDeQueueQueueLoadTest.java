...
public class SynchronizedCostOnDeQueueQueueLoadTest {
	...
	public void test() {
		...
		GenericQueue<Object> queue = new SynchronizedGenericQueueWrapper<Object>(new CostOnDeQueueQueue<Object>());
		int itemsConsumed = 0;
		...
		System.out.println("SynchronizedCostOnDeQueueQueueLoadTest total milliseconds: " + (endTime-startTime));
	}
	...
	public void test_threads() throws InterruptedException {
		...
		Long endTime = System.currentTimeMillis();
		System.out.println("SynchronizedCostOnDeQueueQueueLoadTest total milliseconds (" + NUMBER_OF_THREADS + " threads): " + (endTime-startTime));
	}
